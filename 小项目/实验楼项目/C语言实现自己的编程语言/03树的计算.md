...
我们可以通过数组的方法来访问我们的子节点，数组的访问方式就是---变量名 + 下标，比如我们访问第一个字节点的时候我们可以使用 `children[0]` ，需要注意的是 C/C++ 的第一个元素下标是 0 而不是 1 。
...
**注意 evaluation.c 须放在 `/home/shiyanlou/mpc-master/` 目录下**：**编写源程序 evaluation.c：**
